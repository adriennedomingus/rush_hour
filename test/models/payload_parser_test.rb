...
class PayloadParserTest < MiniTest::Test
  ...
  def test_payload_parser_parses
    ...
    payload_hash = parsed_data.payload_into_hash(payload)
    ...
    assert_equal RequestType, payload_hash[:verb].class
    assert_equal "GET", payload_hash[:verb].verb
    ...
    assert_equal "63.29.38.211", payload_hash[:ip]
  end
end
